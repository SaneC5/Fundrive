...
const selfCars = [
    ...
    },
    {
        ...
        description: "Elegant and sophisticated vehicle for business and leisure.",
        features: [
            { type: "body", value: "Hatchback" },
    ...
    },
    {
        ...
        description: "Performance-oriented luxury sedan with cutting-edge technology.",
        features: [
            { type: "body", value: "Hatchback" },
            { type: "transmission", value: "manual" },
            { type: "fuel", value: "Petrol" },
    ...
    },
    {
        name: "i20 (Old)",
        image: "img/i20-2.jpg",
        description: "Luxury compact SUV with off-road capabilities and premium interior.",
        features: [
            { type: "body", value: "Hatchback" },
            { type: "transmission", value: "Auto" },
            { type: "fuel", value: "Petrol" },
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="car-card fade-in" style="animation-delay: ${index * 0.1}s">
                    ...
                    <div class="car-info">
                        ...
                        <button class="btn btn-book2 dg-btn" onclick="bookCar('${car.name}')">
                            <span>
...
function bookCar(carName) {
    // Find the car details based on carName
    const car = 
        (typeof selfCars !== 'undefined' && selfCars.find(c => c.name === carName)) ||
        (typeof taxiCars !== 'undefined' && taxiCars.find(c => c.name === carName)) ||
        (typeof yacht !== 'undefined' && yacht.find(c => c.name === carName));
    ...
    if (car) {
        ...
        // Add features safely if they exist
        ...
        // Add a closing line
        // message += `You can reply below with your questions`;

        // WhatsApp contact number
        const phoneNumber = '9764976913'; // Replace with your real WhatsApp number
...
const blogPosts = [
    ...
    },
    {
        ...
        category: "Car Guides",
        excerpt: "Harvalem (Arvalem) Waterfall, Harvalem Sanquelim - Golden GoaHarvalem Waterfall in North Goa is a 70-meter (or 50-meter) cascade in the Sanquelim area, known for its serene atmosphere, scenic views, and nearby Arvalem Caves (Pandav Caves) and Rudreshwar Temple. It is an ideal spot for a refreshing experience, especially during the monsoon season, though it remains enjoyable even during non-monsoon times",
        author: "Mike Davis",
        date: "2024-01-12",
        tags: "cars, guide, rental",
        filter: "guides"
    },
    {
        id: 3,
    ...
    },
    {
        ...
        category: "Travel Tips",
        excerpt: "People say this fortress offers stunning panoramic views of the Arabian Sea and the surrounding landscape, and is a great spot for photography. They also highlight the peaceful atmosphere, the well-preserved historical architecture, and the affordable entry fee",
        author: "John Smith",
        date: "2024-01-08",
        tags: "insurance, tips, safety",
        filter: "tips"
    },
    {
        id: 5,
        ...
        category: "Car Guides",
        excerpt: "People say this fortress offers breathtaking panoramic views of the sea, Vagator Beach, and the surrounding landscape, especially during sunset. They also highlight the peaceful and relaxing vibes, and the cool breeze",
        author: "David Brown",
        date: "2024-01-05",
    ...
    },
    {
        ...
        category: "Travel Tips",
        excerpt: "People say this historical fort offers stunning views of the Mandovi River and Arabian Sea, and features interesting exhibits about Goa's history. They also highlight the well-maintained architecture, the peaceful and less crowded atmosphere, and the reasonable entry fee",
        author: "Lisa Garcia",
        date: "2024-01-03",
    ...
    },
    {
        ...
        category: "Industry News",
        excerpt: "People say this fortress offers stunning panoramic views of the Arabian Sea and a serene pebble beach. They also highlight the peaceful and tranquil atmosphere, perfect for relaxation and photography, and the free entry",
        author: "Tech Team",
        date: "2024-01-01",
        tags: "technology, innovation, apps",
        filter: "news"
    },
    {
        id: 8,
    ...
    },
    {
        ...
        category: "Car Guides",
        excerpt: "Most Famous Beach of Goa, Baga Beach, Famous among  Tourists, One of the most Visited Beach of Goa. Known for its Beach Shacks,  Water Sports, and Night Life. , 100 Days Challenge - Day 51 / ...Baga Beach is a popular and lively beach in North Goa, famous for its vibrant nightlife, water sports, and beachfront restaurants and shacks. It is a major tourist destination with a wide variety of activities, including water sports like parasailing and jet skiing, and a buzzing market that leads to the shore",
        author: "Car Expert",
        date: "2023-12-25",
        tags: "suv, sedan, comparison",
        filter: "guides"
    },
    {
        id: 10,
        ...
        category: "Travel Tips",
        excerpt: "Anjuna Beach is a popular destination in North Goa, known for its vibrant atmosphere, rocky and sandy shores, lively nightlife, and hippie culture. It is a great place for tourists and partygoers, offering water sports, beach shacks, and beautiful sunsets. Anjuna Beach is free to enter 24/7, but visiting during the day is best between 7 AM and 6:30 PM",
        author: "Safety Team",
        date: "2023-12-22",
    ...
    },
    {
        ...
        category: "Travel Tips",
        excerpt: "Know About Morjim and Why Choose MorjimMorjim Beach is a tranquil beach in North Goa known for its pristine white sand, relaxed atmosphere, and as a nesting ground for the endangered Olive Ridley turtles. It's a popular destination for water sports like kite-surfing, yoga, and for enjoying fresh seafood at local beach shacks. Due to its popularity with Russian tourists, it's also known as 'Little Russia'.",
        author: "Family Expert",
        date: "2023-12-18",
        tags: "family, roadtrip, planning",
        filter: "tips"
    },
    {
        id: 13,
        ...
        category: "Car Guides",
        excerpt: "Arambol Beach is a vibrant, bohemian beach in North Goa, India, known for its soft golden sands, calm waters, and a unique blend of relaxation, adventure, and culture. It is famous for its laid-back vibe, with activities like yoga sessions, drum circles at sunset, paragliding, and dolphin watching. The beach features a sweet water lake, a local market, various shacks, and live music, offering a lively but informal atmosphere for tourists",
        author: "Summer Team",
        date: "2023-12-15",
        tags: "convertible, summer, experience",
        filter: "guides"
    },
    {
        id: 14,
    ...
    },
    {
        ...
        category: "Car Guides",
        excerpt: "Palolem Beach is a crescent-shaped beach located in South Goa, India, known for its calm, clear waters, lively atmosphere with colorful shacks, and unique nightlife including 'silent discos'. It is a popular tourist destination, especially during the winter months (November to March), offering opportunities for swimming, kayaking, yoga, and exploring nearby attractions like Butterfly Beach. The beach provides a relaxed yet vibrant Goan experience, with many shops, international cuisine restaurants, and options for beachfront dining",
        author: "Business Team",
        date: "2023-12-08",
        tags: "business, corporate, solutions",
        filter: "guides"
    },
    {
        id: 17,
        ...
        category: "Industry News",
        excerpt: "Visitors say this beach offers white sand, clean shores, and crystal-clear waters, perfect for relaxation and long walks. They also highlight the peaceful and serene atmosphere, with fewer crowds compared to other popular beaches, making it ideal for families and couples seeking tranquility",
    ...
    },
    {
        ...
        category: "Industry News",
        excerpt: "Nagueshi or Nagesh is a form of the Hindu god Shiva worshipped by Konkani Hindus of the Gaud Saraswat Brahmin community in India. The temple lies in verdant surroundings in the Ponda district of Goa. Unlike many other Hindu temples of Goa which were shifted out of the Velha Conquistas the Nagueshi Temple is at its original place. It has, however, been renovated a number of times. It is located in Bandode village, Ponda, North Goa district",
        author: "Service Team",
        date: "2023-11-28",
        tags: "service, excellence, customer",
        filter: "news"
    ...
    },
    {
        ...
        category: "Industry News",
        excerpt: "Beach contains coarse sand and rocks and, is found at the mouth of Zuari river. Along the beach one can also find boats that are used by the local fishing community. The beach is a haven for shell collectors and one can easily find myriad types of shells here. It is located 7 km from the center of Panaji.",
        author: "Service Team",
        date: "2023-11-28",
        tags: "service, excellence, customer",
        filter: "news"
    },
    {
        ...
        category: "Industry News",
        excerpt: "Salavali Dam (Salaulim Dam), which is pronounced local Salauli Dam Says, India K Goa Of the state South Goa district K Sangem One located near the city Dam Is. It is situated on the Salavali River, which Zuwari River Of one Tributary Is",
        author: "Service Team",
        date: "2023-11-28",
        tags: "service, excellence, customer",
        filter: "news"
    ...
    },
    {
        ...
        category: "Industry News",
        excerpt: "Sanna is a traditional Goan steamed rice cake, often enjoyed as a soft, spongy snack or accompaniment to spicy curries. The sweet version, known as Godd Sanna or Chunachi Sanna, features a filling of coconut and jaggery, making it a popular tea-time treat. This recipe uses fermented batter made from rice and coconut, with the sweet variant incorporating jaggery and cardamom for a rich, aromatic flavor.",
        author: "Service Team",
        date: "2023-11-28",
        tags: "service, excellence, customer",
        filter: "news"
    ...
    },
    {
        ...
        category: "Industry News",
        excerpt: "Goan Chicken Cafreal is a traditional Goan dish with Portuguese and African influences, originating from the Portuguese colonies in Africa and introduced to Goa during the colonial period. It is a rustic chicken curry made with a distinctive green masala paste, known for its aromatic, smoky, and fresh flavors, typically served with bread, potatoes, or rice",
        author: "Service Team",
        date: "2023-11-28",
        tags: "service, excellence, customer",
        filter: "news"
    ...
    },
    {
        ...
        category: "Industry News",
        excerpt: "Goan Chicken Xacuti is a rich, aromatic curry from the coastal region of Goa, India, known for its complex blend of spices and fresh coconut, creating a fiery yet balanced flavor profile. It is traditionally made with chicken marinated in a green masala and cooked in a thick, fragrant coconut-based sauce.",
        author: "Service Team",
        date: "2023-11-28",
        tags: "service, excellence, customer",
        filter: "news"
